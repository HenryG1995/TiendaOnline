...
var prueba = new InsertarBlobs();

var F = prueba.blob_images("", constr);
...
//var dto = new procesa_imagen();


//dto.imagen = "data:image";

//dto.uuid = Guid.NewGuid().ToString();

//var query = new Query("TABLA_PRUEBAS").AsInsert(dto);

//var sql = execute.ExecuterCompiler(query);

//if (sql.ToString().Contains(",'data/image'"))
//{
//    var newquery = sql.Replace("'data:image'", "bigtext");
//    var str = @"
...
//    var e = execute.ExecuterOracle(str);
